...
<section class="w-full bg-[#f6f5f2] relative lg:py-16 md:py-8 py-6  animate-bg-zoom bg-[url(<?php echo get_template_directory_uri(); ?>/assets/img/elevate4.webp)] bg-cover bg-center">
  <div class="max-w-7xl mx-auto px-4 px-4 lg:px-6">
      ...
      <!-- <div class="w-full flex items-center flex-row justify-center lg:gap-x-10 gap-6 flex-wrap">
        <a href="<?php the_field('innovative_product_link'); ?>" class="flex items-center gap-2 lg:text-lg tracking-[0.5px] font-medium bg-[#bf4b50] py-3 px-6 rounded-md text-white text-center duration-300 hover:bg-[#000000]">
        ...
        <a href="<?php the_field('innovative_service_link'); ?>" class="flex items-center gap-2 lg:text-lg tracking-[0.5px] font-medium bg-[#000000] py-3 px-6 rounded-md text-white text-center duration-300 hover:bg-[#bf4b50]">
      ...
      <div class="w-full product flex flex-col items-center lg:gap-6 gap-4">
        <div class="flex flex-col gap-y-3">
          <h4 class="text-start"><?php the_field('product_1'); ?></h4>
          <div class="flex flex-col gap-y-2">
            <h4><?php the_field('product_title_1'); ?></h4>
          ...
          <div class="flex flex-col gap-y-2">
            <h4><?php the_field('product_title_3'); ?></h4>
            <p><?php the_field('product_description_3'); ?></p>
          </div>
        </div>
      </div>
      <div class="w-full service flex flex-col items-center lg:gap-6 gap-4">
        <div class="flex flex-col gap-y-3">
          <h4 class="text-start"><?php the_field('product_1'); ?></h4>
          <div class="flex flex-col gap-y-2">
            <h4><?php the_field('product_title_1'); ?></h4>
