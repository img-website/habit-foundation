    ...
    <div class="w-full flex flex-col items-center lg:gap-6 gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 ">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_1'); ?>" title="<?php the_field('event_title_1'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 ">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_2'); ?>" title="<?php the_field('event_title_2'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 " >
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_3'); ?>" title="<?php the_field('event_title_3'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 " >
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_4'); ?>" title="<?php the_field('event_title_4'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 " >
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_5'); ?>" title="<?php the_field('event_title_5'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 ">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_6'); ?>" title="<?php the_field('event_title_6'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_7'); ?>" title="<?php the_field('event_title_7'); ?>" width="373" height="240" class="size-full border border-gray-200 object-contain rounded-md">
            </div>
          <?php endif; ?>
          <?php $img1 = get_field('event_image_21'); ?>
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_7'); ?>" title="<?php the_field('event_title_7'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_8'); ?>" title="<?php the_field('event_title_8'); ?>" width="373" height="240" class="size-full border border-gray-200 object-contain rounded-md">
            </div>
          <?php endif; ?>
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_8'); ?>" title="<?php the_field('event_title_8'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
    ...
    <div class="w-full flex flex-col items-center lg:gap-6 gap-4 lg:mt-14 mt-6">
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_9'); ?>" title="<?php the_field('event_title_9'); ?>" width="373" height="240" class="size-full border border-gray-200 object-contain rounded-md">
            </div>
          <?php endif; ?>
          <?php $img1 = get_field('event_image_29'); ?>
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_9'); ?>" title="<?php the_field('event_title_9'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_10'); ?>" title="<?php the_field('event_title_10'); ?>" width="373" height="240" class="size-full border border-gray-200 object-contain rounded-md">
            </div>
          <?php endif; ?>
          <?php $img1 = get_field('event_image_32'); ?>
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-64 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_10'); ?>" title="<?php the_field('event_title_10'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
            </div>
          <?php endif; ?>
      ...
      <div class="w-full h-full flex lg:flex-row flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="lg:w-1/5 w-full h-full flex items-end">
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-80 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_13'); ?>" title="<?php the_field('event_title_13'); ?>" width="473" height="440" class="size-full object-contain rounded-md ">
            </div>
        </div>
      </div>
      ...
      <div class="w-full h-full flex lg:flex-row flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <?php endif; ?>
          ...
          <?php if ($img1): ?>
            <div class="py-2 px-2 w-full lg:h-80 h-full">
              <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_12'); ?>" title="<?php the_field('event_title_12'); ?>" width="473" height="440" class="size-full object-contain rounded-md ">
            </div>
          <?php endif; ?>
        </div>
      </div>
      ...
      <div class="w-full h-full flex flex-col bg-white border border-[#e9e7e3] rounded-xl shadow-sm duration-300 group md:group-hover:shadow-lg lg:px-4 lg:py-4 px-2 py-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4">
            ...
            <?php if ($img1): ?>
              <div class="py-2 px-2 w-full lg:h-64 h-full">
                <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_13'); ?>" title="<?php the_field('event_title_13'); ?>" width="373" height="240" class="size-full border border-gray-200 object-contain rounded-md">
              </div>
            <?php endif; ?>
            ...
            <?php if ($img1): ?>
              <div class="py-2 px-2 w-full lg:h-64 h-full">
                <img src="<?php echo esc_url($img1['url']); ?>" alt="<?php the_field('event_title_13'); ?>" title="<?php the_field('event_title_13'); ?>" width="373" height="240" class="size-full object-cover rounded-md ">
              </div>
            <?php endif; ?>
