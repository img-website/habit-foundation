            ...
            <div class="content-sec w-full">
                <div class="block">
                    ...
                    <div class="flex flex-wrap gap-6">
                        <button class="agile-tab-btn text-base lg:text-lg font-semibold px-4 py-3 border-b-2 border-[#bf4b50] text-[#bf4b50]" data-tab="tab1">HABITia 2024</button>
                        <button class="agile-tab-btn text-base lg:text-lg font-semibold px-4 py-3 text-gray-700" data-tab="tab2">Alchemize 2024</button>
                        <button class="agile-tab-btn text-base lg:text-lg font-semibold px-4 py-3 text-gray-700" data-tab="tab3">Technothon</button>
                    </div>
                    <!-- Tab Content -->
                ...
                <div class="w-full event-tabs2">
                    <div class="w-full flex flex-wrap gap-6">
                        <button class="orientation-tab-btn text-base lg:text-lg font-semibold px-4 py-3 border-b-2 border-[#bf4b50] text-[#bf4b50]" data-tab="orientation-tab">HABIT Orientation</button>
                        <button class="horizon-tab-btn text-base lg:text-lg font-semibold px-4 py-3 text-gray-700" data-tab="horizon-tab">HABIT Patent Horizon</button>
                    </div>
                    <!-- tab content -->
                ...
                <div class="block">
                    ...
                    <div class="hidden peer-checked:flex flex-wrap">
                        <div class="w-full flex flex-wrap">
                            <button class="design-tab-btn text-base lg:text-lg font-semibold px-4 py-3 border-b-2 border-[#bf4b50] text-[#bf4b50]" data-tab="design-tab">Design Thinking</button>
                        </div>
                    </div>
                </div>
            </div> 
