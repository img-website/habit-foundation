                ...
                <li class="group/event">
                    <label for="event3"
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div
                                class="text-[#bf4b50] group-has-[#event3:checked]:!text-white  font-semibold tracking-[0.5px] lg:text-base xs:text-[13px] sm:text-sm">
                                Upcoming Event
                            </div>
                        </div>
                    ...
                    <div class="hidden peer-checked:flex flex-wrap *:w-auto">
                        <div class="w-full event-tabs ">
                            <div class="flex flex-wrap gap-6">
                                <button
                                    class="agile-tab-btn text-base lg:text-lg font-semibold px-4 py-3 border-b-2 border-[#bf4b50] text-[#bf4b50]"
                                    data-tab="tab1">HABITia 2024</button>
                                <button class="agile-tab-btn text-base lg:text-lg font-semibold px-4 py-3 text-gray-700"
                                    data-tab="tab2">Alchemize 2024</button>
                                <button class="agile-tab-btn text-base lg:text-lg font-semibold px-4 py-3 text-gray-700"
                                    data-tab="tab3">Technothon</button>
                            </div>
                            <!-- Tab Content -->
                    ...
                    <div class="hidden peer-checked:flex flex-wrap *:w-auto">
                        ...
                        <div class="w-full event-tabs2">
                            <div class="w-full flex flex-wrap gap-6">
                                <button
                                    class="orientation-tab-btn text-base lg:text-lg font-semibold px-4 py-3 border-b-2 border-[#bf4b50] text-[#bf4b50]"
                                    data-tab="orientation-tab">HABIT Orientation</button>
                                <button
                                    class="horizon-tab-btn text-base lg:text-lg font-semibold px-4 py-3 text-gray-700"
                                    data-tab="horizon-tab">HABIT Patent Horizon</button>
                            </div>
                            <!-- tab content -->
                    ...
                    <div class="hidden peer-checked:flex flex-wrap">
                        <div class="w-full flex flex-wrap">
                            <button
                                ...
                                data-tab="design-tab">Design Thinking</button>
                        </div>
                    </div>
                </div>
            </div>
